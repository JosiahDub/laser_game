...
class Picker:
    ...
    def __init__(self):
        self.root = Tk()
        f = font.Font(family='Helvetica', size=90, weight=font.BOLD)
        ...
        self.maze_button = Button(self.root, text='Maze',
                                  command=self.play_maze, font=f,
                                  bg='#303030', fg='white')
        self.maze_button.bind('<Return>', lambda event:self.play_maze())
        self.maze_button.grid(row=0, column=0, sticky=N+S+E+W)
        self.pong_button = Button(self.root, text='Pong',
                                  command=self.play_pong, font=f,
                                  bg='#303030', fg='white')
        self.pong_button.bind('<Return>',
                              lambda event:self.play_pong())
        ...
        self.missile_defense_button = Button(self.root, text='Missile Defense',
                                             ...
                                             font=f, bg='#303030', fg='white')
        self.missile_defense_button.bind('<Return>',
                                         lambda event:self.play_missile_defense())
